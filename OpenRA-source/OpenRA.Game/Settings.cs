...
namespace OpenRA
{
	...
	public class GameSettings
	{
		...
		[Desc("Pathfinding algorithm to use. Options: OpenRA, ClassicCnC, Improved")]
		public string PathfindingAlgorithm = "OpenRA";

		[Desc("Aircraft landing algorithm to use. Options: OpenRA, ClassicCnC, Improved")]
		public string AircraftLandingAlgorithm = "OpenRA";

		[Desc("Docking algorithm for harvesters, aircraft, and repair units. Options: OpenRA, ClassicCnC, Improved")]
		public string DockingAlgorithm = "OpenRA";
